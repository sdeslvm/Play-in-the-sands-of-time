...
enum PlayInWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: PlayInWebStatus) -> Bool {
        switch (self, other) {
...
extension PlayInWebStatus {
    static func == (lhs: PlayInWebStatus, rhs: PlayInWebStatus) -> Bool {
