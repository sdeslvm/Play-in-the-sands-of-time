...
protocol WebLoadable: AnyObject {
    var state: PlayInWebStatus { get set }
...
final class PlayInWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: PlayInWebStatus = .standby
...
extension PlayInWebLoader: WKNavigationDelegate {
