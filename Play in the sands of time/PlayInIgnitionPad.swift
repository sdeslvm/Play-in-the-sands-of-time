...
struct PlayInWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: PlayInWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> PlayInWebCoordinator {
        PlayInWebCoordinator { [weak loader] status in
