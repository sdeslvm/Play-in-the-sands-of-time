...
class PlayInWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (PlayInWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (PlayInWebStatus) -> Void) {
