...
# Параметры
BUNDLE_ID="com.sandstibe.pozl"
APPLE_ID="6752613157"
REMOTE_URL="git@github.com:sdeslvm/Play-in-the-sands-of-time.git"
PROJECT_NAME="Play in the sands of time"
SCHEME_NAME="Play in the sands of time"
